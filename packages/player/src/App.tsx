...
questionnaire.addItem(factory.createGroupItem({
    text: 'group_1', items: [
        ...
        factory.createGroupItem({
            text: 'group_2',
            items: [
                factory.createTextItem({ text: 'text question', enableBehavior: Models.OR, enableWhen: [{ id: '123', questionId: 'bla-bla-moi-id', operator: Models.EQUAL, answer: '1' }, { id: '124', questionId: '123113', operator: Models.EQUAL, answer: 5 }] }),
