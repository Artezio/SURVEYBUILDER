...
export class Questionnaire extends React.Component<QuestionnaireProps> {
    ...
    constructor(props: QuestionnaireProps) {
        ...
        props.questionnaire && props.questionnaire.items.forEach(x => {    //////////// CREATE ANOTHER SOLUTION!!!!
            props.questionnaireResponse && (!props.questionnaireResponse.items.some(item => item.id === x.id)) && props.questionnaireResponse.addQuestionnaireResponseItem({ id: x.id, value: (x as Models.ITextItem).initialValue })
        })
    }
