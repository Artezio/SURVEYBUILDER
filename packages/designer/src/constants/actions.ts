...
export type ACTION = CREATE_QUESTIONNAIRE | SET_TITLE | SET_DESCRIPTION | ADD_ITEM | ADD_TEXT_ITEM | REMOVE_ITEM | UPDATE_QUESTIONNAIRE | UPDATE_ITEM | UPDATE_TEXT_ITEM;