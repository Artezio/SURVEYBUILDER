...
export const mapOperatorFromModel = (operator: Models.EnableWhenOperator): FHIREnableWhenOperator.FHIREnableWhenOperator => {
    switch (operator) {
        ...
        default: return FHIREnableWhenOperator.EXISTS;
    }
}

export default mapOperatorFromModel;